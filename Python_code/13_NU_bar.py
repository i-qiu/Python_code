...
ax.plot([center_x1 - line_width, center_x1 - line_width], [y1 - 0.2, y1], color='black', lw=1.5)
ax.plot([center_x1 + line_width, center_x1 + line_width], [y1 - 0.2, y1], color='black', lw=1.5)
...
ax.plot([center_x2 - line_width, center_x2 - line_width], [y2 - 0.2, y2], color='black', lw=1.5)
ax.plot([center_x2 + line_width, center_x2 + line_width], [y2 - 0.2, y2], color='black', lw=1.5)
...
ax.set_ylim(0, 15)
plt.ylabel(f"{variable} (g m$^{-2}$)",fontsize=16)
