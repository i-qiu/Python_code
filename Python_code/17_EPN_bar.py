...
variable = 'Effective_panicles_number'
...
ax.plot([center_x1 - line_width, center_x1 - line_width], [y1 - 10, y1], color='black', lw=1.5)
ax.plot([center_x1 + line_width, center_x1 + line_width], [y1 - 10, y1], color='black', lw=1.5)
...
ax.plot([center_x2 - line_width, center_x2 - line_width], [y2 - 10, y2], color='black', lw=1.5)
ax.plot([center_x2 + line_width, center_x2 + line_width], [y2 - 10, y2], color='black', lw=1.5)
...
ax.set_ylim(0, 400)
plt.ylabel(f"Effective panicles number (m$^{-2}$)",fontsize=16)
