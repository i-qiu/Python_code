...
ax.plot([center_x1 - line_width, center_x1 - line_width], [y1 - 2, y1], color='black', lw=1.5)
ax.plot([center_x1 + line_width, center_x1 + line_width], [y1 - 2, y1], color='black', lw=1.5)
...
ax.plot([center_x2 - line_width, center_x2 - line_width], [y2 - 2, y2], color='black', lw=1.5)
ax.plot([center_x2 + line_width, center_x2 + line_width], [y2 - 2, y2], color='black', lw=1.5)
